...
//    }
    ...
    @Test
    public void dataStreamStartsNull() {
        assertNull(computer.getDataStream());
    }

    @Test
    public void keyPressSetsDataStream(){
        keyboard.keyPress('X');
        computer.inputData();
        assertEquals("data: keypress: 'X'", computer.getDataStream());
    }

    @Test
    public void canOutputDataStreamUsingOutputDevice() {
        keyboard.keyPress('X');
        computer.inputData();
        assertEquals("data: keypress: 'X' is now on screen", computer.outputDataStream());
    }
}
